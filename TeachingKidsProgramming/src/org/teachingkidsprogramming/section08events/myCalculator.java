...
public class myCalculator
{
  public static void main(String[] args)
  {
    ...
    int answer1 = MessageBox.askForNumericalInput(
        "Enter (1) for addition, (2) for subtraction, (3) for mulitplication, (4) for divsion, (5) for exponents:");
    ...
    {
      MessageBox.showMessage("The number you entered is not a choice.");
      System.exit(0);
    }
  }
